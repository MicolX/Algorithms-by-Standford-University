...
public class Point implements Comparable<Point> {
    ...
    private class BySlope implements Comparator<Point> {
        public int compare(Point i, Point j) {
            if (slopeTo(i) - slopeTo(j) > 0) return 1;
            else if (slopeTo(i) - slopeTo(j) < 0) return -1;
            else return 0;
        }
    }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point checkPoint = new Point(1234, 5678);
        Point p1 = new Point(14000, 10000);
        Point p2 = new Point(18000, 10000);
        double slope1 = checkPoint.slopeTo(p2);
        double slope2 = checkPoint.slopeTo(p1);
